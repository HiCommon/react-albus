    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Wizard.__proto__ || Object.getPrototypeOf(Wizard)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState({ steps: steps }, function () {
        ...
        if (step.id) {
          ...
          _this.history.replace('' + _this.basename + _this.ids[0] + _this.historySuffix);
        }
      });
    }, _this.push = function () {
      var step = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.nextStep;
      return _this.history.push('' + _this.basename + step + _this.historySuffix);
    }, _this.replace = function () {
      var step = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.nextStep;
      return _this.history.replace('' + _this.basename + step + _this.historySuffix);
    }, _this.next = function () {
...
Wizard.propTypes = {
  ...
  preserveSearch: _propTypes2.default.bool,
